...
| [landing.rs](src/landing.rs) | 自動着陸オートパイロット（L キー） |
| [control.rs](src/control.rs) | キー入力 → 制御コマンドの純粋写像 |
| [mesh.rs](src/mesh.rs) / [explosion.rs](src/explosion.rs) | 機体・地面・爆発のジオメトリ生成 |
| [app.rs](src/app.rs) / [renderer.rs](src/renderer.rs) / [ui.rs](src/ui.rs) | ウィンドウ・Vulkan 描画・HUD |
